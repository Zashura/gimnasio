   ...
   /** 
    ...
    protected void verificacionAcceso(String userName, String url) {
    	UsuarioRolAplicacionServiceRemote usuarioRolAplicacion = ServiceLocator
				.buscarInstancia(ec.com.gimnasio.resources.Constantes.URL_SEGURIDADES, UsuarioRolAplicacionServiceRemote.class, Boolean.TRUE);
	 ...
	 * @return Verdadero o falso si el usuario tiene o no acceso al recurso
	 */
	protected boolean verificarAcceso(String userName, String url) {
		UsuarioRolAplicacionServiceRemote usuarioRolAplicacion = ServiceLocator
				.buscarInstancia(ec.com.gimnasio.resources.Constantes.URL_SEGURIDADES,
						UsuarioRolAplicacionServiceRemote.class, Boolean.TRUE);
		return usuarioRolAplicacion.verificacionAcceso(userName, url);
	}
